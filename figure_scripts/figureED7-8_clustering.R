...
pacman::p_load(terra, sf, Polychrome, dplyr, viridis, maps, paletteer, ggthemes, ggplot2, rnaturalearth, rnaturalearthdata, ggpubr)
...
var_contrib_plot <- readRDS("./cluster_analysis/plot_env.pca_variable_contributions.rds") # written in hierarchical_clustering_envdat.R

# read pca for K=6
pca_envdat_k6 <- readRDS("./cluster_analysis/plot_env.pca_clusters_k6.rds") # written in hierarchical_clustering_envdat.R
...
# Adaptive Capacity score
spat_clust <- read.csv('./cluster_analysis/spatial_clusters.csv') # written in cluster_hierarchical_spatial.R
ac.score <- read.csv('./score_outputs/score_genomicselection_accession_updatedregions.csv')
